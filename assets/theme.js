...
/**
 * Intercepts Shopify add-to-cart form submissions.
 * Adds the item via AJAX and opens the cart panel without page reload.
 */
...
function openQuickView(productHandle) {
  ...
  // Fetch product JSON via Shopify
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Quick view close on overlay click
